...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x6_3(KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_UP, KC_NO, KC_NO, KC_NO, LCTL_T(KC_ESC), LCTL(KC_Y), KC_LSFT, KC_LALT, KC_TAB, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_BRID, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_VOLD, KC_VOLU, KC_MRWD, KC_MPLY, KC_MFFD, KC_NO, KC_BRIU, KC_LGUI, KC_TRNS, KC_SPC, KC_SPC, MO(4), KC_RALT),
